...
{:tag => 'misc_yds', :words => 'Total miscellaneous yards'},
{:tag => 'misc_top', :words => 'misc_top'},
{:tag => 'misc_ona', :words => 'misc_ona'},
{:tag => 'misc_onm', :words => 'misc_onm'},
{:tag => 'misc_ptsto', :words => 'misc_ptsto'},
...
{:tag => 'redzone_endfga', :words => 'Total redzone end field goals attempted'},
{:tag => 'redzone_enddowns', :words => 'redzone_enddowns'},
{:tag => 'redzone_endint', :words => 'Total redzone interceptions thrown'},
{:tag => 'redzone_endfumb', :words => 'Total redzone end fumbles'},
{:tag => 'redzone_endhalf', :words => 'redzone_endhalf'},
{:tag => 'redzone_endgame', :words => 'redzone_endgame'},
...
{:tag => 'defense_brup', :words => 'Total defensive broken up passes'},
{:tag => 'defense_qbh', :words => 'Total defensive quarterback hits'},
...
{:tag => 'pr_no', :words => 'Total punt returns'},
{:tag => 'pr_yds', :words => 'Total punt return yards'},
{:tag => 'pr_td', :words => 'Total punt return touchdowns'},
{:tag => 'pr_long', :words => 'Longest punt return'},
